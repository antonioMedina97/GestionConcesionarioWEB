 ...
 */
@WebServlet(description = "Primer Servlet", urlPatterns = { "/ListadoConcesionarios02" })
public class ListadoConcesionarios02 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListadoConcesionarios02() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Concesionario con : concesionarios) {
			response.getWriter().append("" +
				"  <tr>\r\n" + 
				"    <td><a href=\"FichaConcesionario02?idConcesionario=" + con.getId() + "\">" + con.getCif() + "</a></td>\r\n" + 
				"    <td>" + con.getNombre() + "</td>\r\n" + 
		...
		response.getWriter().append("" + 
		"</table>\r\n" + 
		"<p/><input type=\"submit\"  name=\"nuevo\" value=\"Nuevo\"  onclick=\"window.location='FichaConcesionario02?idConcesionario=0'\"/>" + 
		"</body>\r\n" + 
		"</html>\r\n" + 
		"");
